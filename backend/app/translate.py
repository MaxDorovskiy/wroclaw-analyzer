...
piętro -> поверх (польська нумерація: 1 piętro = наш 2-й поверх)
pokój / pokoje -> кімната / кімнати
kawalerka -> однокімнатна (студія)
osiedle -> осиедле (мікрорайон)
...
SYSTEM_PROMPT = (
    ...
    u"(латиницею, як в оригіналі), ціни та одиниці. Не додавай нічого від себе, "
