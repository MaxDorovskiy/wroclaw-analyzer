...
# Порт сервера
$env:WRO_PORT = "8020"
# Слушать только этот ПК (раскомментировать, пока нет правила брандмауэра);
# по умолчанию сервер виден всей домашней сети — так он нужен Mac и телефону
# $env:WRO_HOST = "127.0.0.1"
